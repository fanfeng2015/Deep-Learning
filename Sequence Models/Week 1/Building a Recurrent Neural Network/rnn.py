...
def rnn_backward(da, caches):
    ...
    (caches, x) = (caches[0], caches[1])       # caches is a tuple: the first element is a list, the second is x
    (a1, a0, x1, parameters) = caches[0]       # caches is a list of tuples, get the first cache tuple
